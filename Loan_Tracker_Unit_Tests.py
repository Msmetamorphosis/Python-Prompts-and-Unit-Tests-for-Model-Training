...
def modify_loan_balance(loan_details: dict) -> None: 
    ...
    interest_rate = loan_details.get('interest_rate') / 100  # Convert percentage to decimal 
...
class TestModifyLoanBalance(unittest.TestCase): 
    ...
    def test_normal_payment(self): 
        ...
        monthly_interest = loan_details['loan_balance'] * (loan_details['interest_rate'] / 100) / 12 
        ...
        self.assertAlmostEqual(loan_details['total_interest_paid'], monthly_interest, places=2) 
